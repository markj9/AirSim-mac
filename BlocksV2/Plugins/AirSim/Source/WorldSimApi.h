...
public:
    ...
    virtual std::string getCameraStream(const std::string& ip_addr, int port, ImageCaptureBase::ImageType image_type, const CameraDetails& camera_details) override;
